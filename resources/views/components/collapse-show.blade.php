<button data-target="{{ $target ?? '' }}" data-toggle="collapse" aria-expanded="true" aria-controls="{{ $target ?? '' }}" {{ 
    $attributes->class([
        'p-4',
        'w-full',
        'bg-gray-100',
    ...
    <div data-icon="collapseExample1" class="transition-transform rotate-180">
