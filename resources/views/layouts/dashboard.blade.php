        ...
        <div class="flex-auto w-full">
            ...
            <main class="container p-4 mx-auto lg:px-6">
                <section class="mt-4 mb-16">
                    ...
                    {{-- View Github --}}
                    <a href="https://github.com/mkfizi/larastart" target="_blank" class="flex justify-between w-full p-4 mb-4 text-sm text-white transition bg-blue-700 rounded hover:bg-blue-600">
                        ...
                        <span id="githubStars" class="hidden gap-2">
                            <span id="githubStarsText"></span>
